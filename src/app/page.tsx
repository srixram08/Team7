...
import { Zap, ArrowRight, ShieldCheck, Globe, Play, UserCheck, Terminal, Server, Layers } from "lucide-react";
...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#F4F6F4] text-[#162215] flex flex-col font-sans selection:bg-[#2E5B28] selection:text-white">
      ...
      <main className="flex-1 w-full pt-32 sm:pt-36 pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24 sm:space-y-32">
          ...
          {/* Hero Section */}
          <section className="text-center space-y-7 max-w-4xl mx-auto">
            ...
            <h1 className="font-heading text-3xl sm:text-5xl lg:text-6xl font-extrabold text-[#162215] tracking-tight leading-[1.15] max-w-4xl mx-auto">
              High-Stakes Online Exams with <br className="hidden sm:inline" />
              <span className="text-[#2E5B28] inline-block mt-2">Automated 2.4s State Rollback</span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 pt-8 max-w-3xl mx-auto">
              <div className="rounded-2xl border border-[#D6E5D4] bg-white p-6 text-center shadow-sm flex flex-col items-center justify-center space-y-1">
          ...
          <section id="security" className="rounded-3xl bg-gradient-to-br from-[#1E3F1A] to-[#0D2410] px-6 py-12 sm:px-12 sm:py-16 text-center text-white shadow-xl">
            <div className="max-w-3xl mx-auto space-y-6">
              <h2 className="font-heading text-2xl sm:text-4xl font-extrabold leading-tight text-white">
                Secure Your Online Examinations Today
              </h2>
              <p className="text-sm sm:text-base text-[#D6E5D4] leading-relaxed max-w-xl mx-auto">
              ...
              <div className="pt-4 flex flex-wrap justify-center items-center gap-4">
                <Link href="/login">
                  <GlowButton variant="outline" size="lg" className="bg-white text-[#2E5B28] border-white hover:bg-[#E8F3E7] shadow-lg">
                    Sign In to User Dashboard
                  </GlowButton>
                </Link>
                <Link href="/student">
                  <GlowButton variant="secondary" size="lg" className="bg-[#2E5B28] text-white border-[#4E8B46] hover:bg-[#3C7335]">
                    Open Student Portal
                  </GlowButton>
                </Link>
              </div>
